...
<body style="background-color: #3b71ca">
<section class="vh-100">
    <div class="container-fluid h-custom">
        <div class="row d-flex justify-content-center align-items-center h-100">
            <div class="col-md-9 col-lg-6 col-xl-5">
                <img src="https://th.bing.com/th/id/OIP.GhoDeejxQiegKKGRIWypJAHaD4?pid=ImgDet&rs=1"
                ...
                <div class="card p-4 shadow-sm animate__animated animate__fadeIn">
                    <form action="login" method="get">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="newForgot.jsp" class="text-body">Forgot password?</a>
                        </div>
